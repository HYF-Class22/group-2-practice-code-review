import { filterIntersection } from './filter-intersection.js';
...
const cases = [
  ...
  {
    label:
      '[1000000000, 2000000000, 3000000000], [2000000000, 3000000000, 4000000000] => [2000000000, 3000000000]',
  ...
  {
    label:
      '[0.0001, 0.0002, 0.0003], [0.0002, 0.0003, 0.0004] => [0.0002, 0.0003]',
  ...
  {
    label:
      '[999999, 9999999, 99999999], [9999999, 99999999, 999999999] => [9999999, 99999999]',
...
for (const solution of [filterIntersection]) {
  describe(`${solution.name}: return an array of values that are in both the first and the second arrays`, () => {
